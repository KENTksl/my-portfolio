...
var _reactdom = /*#__PURE__*/ _interop_require_default._(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react-dom/index.js [app-client] (ecmascript)"));
...
var _requestidlecallback = __turbopack_context__.r("[project]/node_modules/next/dist/client/request-idle-callback.js [app-client] (ecmascript)");
...
var loadScript = function(props) {
    var src = props.src, id = props.id, _props_onLoad = props.onLoad, onLoad = _props_onLoad === void 0 ? function() {} : _props_onLoad, _props_onReady = props.onReady, onReady = _props_onReady === void 0 ? null : _props_onReady, dangerouslySetInnerHTML = props.dangerouslySetInnerHTML, _props_children = props.children, children = _props_children === void 0 ? '' : _props_children, _props_strategy = props.strategy, strategy = _props_strategy === void 0 ? 'afterInteractive' : _props_strategy, onError = props.onError, stylesheets = props.stylesheets;
    var cacheKey = id || src;
...
function handleClientScriptLoad(props) {
    var _props_strategy = props.strategy, strategy = _props_strategy === void 0 ? 'afterInteractive' : _props_strategy;
...
function addBeforeInteractiveToCache() {
    var scripts = _to_consumable_array._(document.querySelectorAll('[data-nscript="beforeInteractive"]')).concat(_to_consumable_array._(document.querySelectorAll('[data-nscript="beforePageRender"]')));
 ...
 */ function Script(props) {
    var id = props.id, _props_src = props.src, src = _props_src === void 0 ? '' : _props_src, _props_onLoad = props.onLoad, onLoad = _props_onLoad === void 0 ? function() {} : _props_onLoad, _props_onReady = props.onReady, onReady = _props_onReady === void 0 ? null : _props_onReady, _props_strategy = props.strategy, strategy = _props_strategy === void 0 ? 'afterInteractive' : _props_strategy, onError = props.onError, stylesheets = props.stylesheets, restProps = _object_without_properties._(props, [
        "id",
        "src",
        "onLoad",
        "onReady",
    ...
    var _ref = (0, _react.useContext)(_headmanagercontextsharedruntime.HeadManagerContext), updateScripts = _ref.updateScripts, scripts = _ref.scripts, getIsSsr = _ref.getIsSsr, appDir = _ref.appDir, nonce = _ref.nonce;
   ...
   */ var hasOnReadyEffectCalled = (0, _react.useRef)(false);
    ...
    if (strategy === 'beforeInteractive' || strategy === 'worker') {
        if (updateScripts) {
            ...
            loadScript(_object_spread_props._(_object_spread._({}, props), {
                nonce: nonce
            }));
        }
    }
...
var _disablesmoothscroll = __turbopack_context__.r("[project]/node_modules/next/dist/shared/lib/router/utils/disable-smooth-scroll.js [app-client] (ecmascript)");
...
var _errorboundary1 = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/http-access-fallback/error-boundary.js [app-client] (ecmascript)");
...
var _bfcache = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/bfcache.js [app-client] (ecmascript)");
var _apppaths = __turbopack_context__.r("[project]/node_modules/next/dist/shared/lib/router/utils/app-paths.js [app-client] (ecmascript)");
var Activity = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
/**
...
function OuterLayoutRouter(param) {
  ...
  */ var segmentBoundaryTriggerNode = null;
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            var _require = __turbopack_context__.r("[project]/node_modules/next/dist/next-devtools/userspace/app/segment-explorer-node.js [app-client] (ecmascript)"), SegmentBoundaryTriggerNode = _require.SegmentBoundaryTriggerNode, SegmentViewStateNode = _require.SegmentViewStateNode;
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            var SegmentStateProvider = __turbopack_context__.r("[project]/node_modules/next/dist/next-devtools/userspace/app/segment-explorer-node.js [app-client] (ecmascript)").SegmentStateProvider;
...
var _reflect = __turbopack_context__.r("[project]/node_modules/next/dist/server/web/spec-extension/adapters/reflect.js [app-client] (ecmascript)");
var _reflectutils = __turbopack_context__.r("[project]/node_modules/next/dist/shared/lib/utils/reflect-utils.js [app-client] (ecmascript)");
...
var createRenderSearchParamsFromClient = ("TURBOPACK compile-time truthy", 1) ? __turbopack_context__.r("[project]/node_modules/next/dist/client/request/search-params.browser.dev.js [app-client] (ecmascript)").createRenderSearchParamsFromClient : "TURBOPACK unreachable";
if ((typeof exports["default"] === 'function' || _type_of._(exports["default"]) === 'object' && exports["default"] !== null) && typeof exports["default"].__esModule === 'undefined') {
    Object.defineProperty(exports["default"], '__esModule', {
        value: true
    });
...
var createRenderParamsFromClient = ("TURBOPACK compile-time truthy", 1) ? __turbopack_context__.r("[project]/node_modules/next/dist/client/request/params.browser.dev.js [app-client] (ecmascript)").createRenderParamsFromClient : "TURBOPACK unreachable";
if ((typeof exports["default"] === 'function' || _type_of._(exports["default"]) === 'object' && exports["default"] !== null) && typeof exports["default"].__esModule === 'undefined') {
    Object.defineProperty(exports["default"], '__esModule', {
        value: true
    });
...
var _react = /*#__PURE__*/ _interop_require_wildcard(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"));
...
var _asynclocalstorage = __turbopack_context__.r("[project]/node_modules/next/dist/server/app-render/async-local-storage.js [app-client] (ecmascript)");
...
var _aftertaskasyncstorageinstance = __turbopack_context__.r("[project]/node_modules/next/dist/server/app-render/after-task-async-storage-instance.js [app-client] (ecmascript)"); //# sourceMappingURL=after-task-async-storage.external.js.map
}),
...
_export(exports, {
    ...
    throwWithStaticGenerationBailoutError: function throwWithStaticGenerationBailoutError1() {
...
var _staticgenerationbailout = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/static-generation-bailout.js [app-client] (ecmascript)");
var _aftertaskasyncstorageexternal = __turbopack_context__.r("[project]/node_modules/next/dist/server/app-render/after-task-async-storage.external.js [app-client] (ecmascript)");
...
var _creatededupedbycallsiteservererrorlogger = __turbopack_context__.r("[project]/node_modules/next/dist/server/create-deduped-by-callsite-server-error-logger.js [app-client] (ecmascript)");
var _reflectutils = __turbopack_context__.r("[project]/node_modules/next/dist/shared/lib/utils/reflect-utils.js [app-client] (ecmascript)");
var _utils = __turbopack_context__.r("[project]/node_modules/next/dist/server/request/utils.js [app-client] (ecmascript)");
                ...
                case 'status':
                    {
                        var expression1 = '`use(searchParams)`, `searchParams.status`, or similar';
                        if (workStore.dynamicShouldError) {
                            (0, _utils.throwWithStaticGenerationBailoutErrorWithDynamicError)(workStore.route, expression1);
                        } else if (prerenderStore.type === 'prerender-ppr') {
                            // PPR Prerender (no cacheComponents)
                            (0, _dynamicrendering.postponeWithTracking)(workStore.route, expression1, prerenderStore.dynamicTracking);
                        } else {
                            // Legacy Prerender
                            (0, _dynamicrendering.throwToInterruptStaticGeneration)(expression1, workStore, prerenderStore);
                        }
                        return;
                    }
                default:
                    {
                        if (typeof prop === 'string' && !_reflectutils.wellKnownProperties.has(prop)) {
                            var expression2 = (0, _reflectutils.describeStringPropertyAccess)('searchParams', prop);
                            if (workStore.dynamicShouldError) {
                                (0, _utils.throwWithStaticGenerationBailoutErrorWithDynamicError)(workStore.route, expression2);
                            } else if (prerenderStore.type === 'prerender-ppr') {
                                // PPR Prerender (no cacheComponents)
                                (0, _dynamicrendering.postponeWithTracking)(workStore.route, expression2, prerenderStore.dynamicTracking);
                            } else {
                                // Legacy Prerender
                                (0, _dynamicrendering.throwToInterruptStaticGeneration)(expression2, workStore, prerenderStore);
                            }
                        }
                        return _reflect.ReflectAdapter.get(target, prop, receiver);
                    }
...
function makeDynamicallyTrackedExoticSearchParamsWithDevWarnings(underlyingSearchParams, store) {
    ...
    var promiseInitialized = false;
    var proxiedUnderlying = new Proxy(underlyingSearchParams, {
        get: function get(target, prop, receiver) {
    ...
    // supports copying with spread and we don't want to unnecessarily
    // instrument the promise with spreadable properties of ReactPromise.
    var promise = (0, _dynamicrenderingutils.makeDevtoolsIOAwarePromise)(underlyingSearchParams);
        ...
        get: function get(target, prop, receiver) {
            ...
            if (typeof prop === 'string') {
                ...
                Reflect.has(target, prop) === false)) {
                    ...
                    syncIODev(store.route, expression1);
                }
            }
            return _reflect.ReflectAdapter.get(target, prop, receiver);
        },
...
var warnForIncompleteEnumeration = (0, _creatededupedbycallsiteservererrorlogger.createDedupedByCallsiteServerErrorLoggerDev)(createIncompleteEnumerationError);
...
var _dynamicaccessasyncstorageinstance = __turbopack_context__.r("[project]/node_modules/next/dist/server/app-render/dynamic-access-async-storage-instance.js [app-client] (ecmascript)"); //# sourceMappingURL=dynamic-access-async-storage.external.js.map
}),
...
var _dynamicrenderingutils = __turbopack_context__.r("[project]/node_modules/next/dist/server/dynamic-rendering-utils.js [app-client] (ecmascript)");
var _creatededupedbycallsiteservererrorlogger = __turbopack_context__.r("[project]/node_modules/next/dist/server/create-deduped-by-callsite-server-error-logger.js [app-client] (ecmascript)");
var _dynamicaccessasyncstorageexternal = __turbopack_context__.r("[project]/node_modules/next/dist/server/app-render/dynamic-access-async-storage.external.js [app-client] (ecmascript)");
                ...
                if (fallbackParams1) {
                    for(var key1 in underlyingParams){
                        if (fallbackParams1.has(key1)) {
                            return makeErroringExoticParams(underlyingParams, fallbackParams1, workStore, prerenderStore);
                        }
                    }
                }
                break;
...
function makeDynamicallyTrackedExoticParamsWithDevWarnings(underlyingParams, hasFallbackParams, store) {
    ...
    // supports copying with spread and we don't want to unnecessarily
    // instrument the promise with spreadable properties of ReactPromise.
    var promise = hasFallbackParams ? (0, _dynamicrenderingutils.makeDevtoolsIOAwarePromise)(underlyingParams) : Promise.resolve(underlyingParams);
    var proxiedProperties = new Set();
    var unproxiedProperties = [];
    Object.keys(underlyingParams).forEach(function(prop) {
        if (_reflectutils.wellKnownProperties.has(prop)) {
...
function ClientPageRoot(param) {
    ...
    if (typeof window === 'undefined') {
        var workAsyncStorage = __turbopack_context__.r("[project]/node_modules/next/dist/server/app-render/work-async-storage.external.js [app-client] (ecmascript)").workAsyncStorage;
        ...
        var createSearchParamsFromClient = __turbopack_context__.r("[project]/node_modules/next/dist/server/request/search-params.js [app-client] (ecmascript)").createSearchParamsFromClient;
        clientSearchParams = createSearchParamsFromClient(searchParams, store);
        var createParamsFromClient = __turbopack_context__.r("[project]/node_modules/next/dist/server/request/params.js [app-client] (ecmascript)").createParamsFromClient;
        ...
        var createRenderSearchParamsFromClient = __turbopack_context__.r("[project]/node_modules/next/dist/client/request/search-params.browser.js [app-client] (ecmascript)").createRenderSearchParamsFromClient;
        var clientSearchParams1 = createRenderSearchParamsFromClient(searchParams);
        var createRenderParamsFromClient = __turbopack_context__.r("[project]/node_modules/next/dist/client/request/params.browser.js [app-client] (ecmascript)").createRenderParamsFromClient;
...
//# sourceMappingURL=node_modules_next_dist_974cd28f._.js.map